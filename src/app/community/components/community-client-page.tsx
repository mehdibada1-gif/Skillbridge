...
import { type CommunityUser } from "../actions";
...
type CommunityClientPageProps = {
    initialUsers: CommunityUser[];
}

export default function CommunityClientPage({ initialUsers }: CommunityClientPageProps) {
  const [users, setUsers] = useState<CommunityUser[]>(initialUsers);
            ...
            <CardContent className="p-4">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex items-center gap-2 mt-3">
                        <Button variant="outline" size="sm" onClick={handleContactClick} disabled={loadingAuth || !user}>
