...
import { collection, getDocs, orderBy, query, doc, setDoc, deleteDoc, where, getDocs as getSavedDocs } from "firebase/firestore";
...
export default function ArticlesPage() {
  ...
  const fetchSavedArticles = async () => {
    ...
    try {
        ...
        const querySnapshot = await getSavedDocs(savedQuery);
